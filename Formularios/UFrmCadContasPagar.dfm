object FrmCadContasPagar: TFrmCadContasPagar
  ...
  object sGroupBox12: TsGroupBox
    ...
    object edt_IdFavorecido: TsEdit
      Left = 157
      Top = 30
      Width = 55
      Height = 21
      ...
      ParentFont = False
      TabOrder = 2
      OnExit = edt_IdFavorecidoExit
      OnKeyPress = edt_IdFavorecidoKeyPress
      SkinData.SkinSection = 'EDIT'
      BoundLabel.Indent = 0
      BoundLabel.Font.Charset = DEFAULT_CHARSET
      BoundLabel.Font.Color = clWindowText
    ...
    object btn_BuscarFavorecido: TsBitBtn
      ...
      ParentDoubleBuffered = False
      TabOrder = 4
      OnClick = btn_BuscarFavorecidoClick
      SkinData.SkinSection = 'BUTTON'
    end
  end
